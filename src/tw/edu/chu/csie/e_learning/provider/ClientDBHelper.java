...
public class ClientDBHelper extends SQLiteOpenHelper {
	...
	private static final String tar = 
				"CREATE TABLE chu_target ( TID INTEGER unsigned NOT NULL, MapID INTEGER unsigned NOT NULL, Map_Url varchar(50) NOT NULL, MaterialID INTEGER unsigned NOT NULL, Material_Url varchar(50) NOT NULL, PRIMARY KEY (TID));";
	//學習關係資料表
