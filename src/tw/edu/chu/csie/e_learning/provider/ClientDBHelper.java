...
public class ClientDBHelper extends SQLiteOpenHelper {
	...
	private static final String tar = 
				"CREATE TABLE chu_target ( TID INTEGER unsigned NOT NULL, MapID varchar(20) unsigned NOT NULL, MaterialID varchar(20) unsigned NOT NULL,TLearn_Time INTEGER unsigned NOT NULL, PRIMARY KEY (TID));";
	//輔助類建立時運行該方法
	@Override
